...
- **Add Listing** — pick exactly one item from your inventory that you're willing to trade away (1 unit of 1 item type - no stacking). Confirming **removes it from your inventory immediately** and holds it in escrow inside the listing. You get it back in full if you cancel the listing; it's only handed to the buyer once a trade actually completes.
...
- A listing is exactly 1 unit of 1 item type; an offer can contain up to 9 distinct item types, each stackable to any quantity.
